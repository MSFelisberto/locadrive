...
public class VeiculoService {
    ...
    public void saveVeiculo(Veiculo veiculo) {
        ...
        Assert.state(save == 1, "Erro ao salvar o veiculo" + veiculo.getModelo());
    }

    public void updateVeiculo(Veiculo veiculo, Long id) {
        var update = this.veiculoRepository.update(veiculo, id);
        if(update == 0) {
            throw new RuntimeException("Nenhum veiculo foi atualizado ou encontrado");
        };
    }
    ...
    public void deleteVeiculo(Long id) {
        ...
        if(delete == 0) {
            throw new RuntimeException("Nenhum veiculo foi deletado ou encontrado");
        };
    }
}
